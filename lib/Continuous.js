...
{ rtime = rtime || elapsed ()
  ...
  if ( value < attractor.lpos )
  { // we are jumping back. Move follower and attractor by jump amount
...
const setFirstValue = function ( value, rtime )
...
const setSecondValue = function ( value, rtime )
